...
// Without this, a fresh clone or a wiped data/ dir 500'd on every route with "no such table"
// since nothing ever ran the migrations automatically. Applying them here (module-load time, before
