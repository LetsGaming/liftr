 ...
 *
 * Three-step name resolution, closing the "custom exercises show their slug instead of their
 * name" bug: a stored `name` (set only for custom exercises, since catalog exercises have
