...
| **Overview — primary CTA** | Exactly one `.btn-primary` ("Jetzt trainieren") | Present, gradient confirmed live in both themes per `audit/verify/ROUND2-SUMMARY.md` | Matches |
...
| **Finish Sequence — same-band recovery gain** | LP bar animates, no glow/ring layered on | Confirmed live and working per `audit/verify/ROUND2-SUMMARY.md` | Matches |
...
| **Profile — Save CTA** | `.btn-primary` gradient | Confirmed live in both themes (`audit/verify/ROUND2-SUMMARY.md`) | Matches |
